<template>
  <div class="lg:w-1/5 h-screen flex flex-col justify-items-center justify-center bg-black text-green-500">
      <img src="../assets/profile-pic.jpg" class="w-1/2 rounded-full self-center" alt="">
      <h2 class="p-1 uppercase">Michał Kucharski</h2>
      <p class="p-1">FrontEnd Developer</p>
      <p class="p-1">tel: 723-464-919</p>
      <p class="p-1">e-mail: michal.kucharski@mikusoft.eu</p>
      <h2 class="p-1 uppercase">Doświadczenie zawodowe</h2>
      ...
      <p class="p-1 uppercase">Linki zewnętrzne</p>
      <div class="social-links flex justify-center p-1">
        ...
        <a href="https://github.com/michal-kucharski">
